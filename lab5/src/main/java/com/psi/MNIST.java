...
public class MNIST {
    private static final String RESOURCE_PATH = "/home/krab/hakery/PSI/Lab5/Lab5";
    private static final String TRAIN_IMAGES_PATH = RESOURCE_PATH + "/train-images.idx3-ubyte";
    private static final String TRAIN_LABELS_PATH = RESOURCE_PATH + "/train-labels.idx1-ubyte";
    private static final String TEST_IMAGES_PATH = RESOURCE_PATH + "/t10k-images.idx3-ubyte";
    private static final String TEST_LABELS_PATH = RESOURCE_PATH + "/t10k-labels.idx1-ubyte";
